...
const lessonPrompt = ai.definePrompt({
  ...
  - "vocabulary": 
    ...
    {{/if}}
  - "grammarExplanation": {{{grammarFocusInstruction}}} When explaining the chosen grammar topic, ensure your detailed explanation (which MUST be in RUSSIAN) clearly covers its relevant **morphological aspects** (e.g., word formation, declensions, conjugations, endings) and **syntactic aspects** (e.g., sentence structure, word order, function of grammatical elements within the sentence). For levels A0-B2, systematically try to include grammar topics related to verbs (tenses, modals, reflexives, common strong/irregular verbs, word order with verbs, etc.), while respecting the mandatory list provided in grammarFocusInstruction.
